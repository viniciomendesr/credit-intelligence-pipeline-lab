...
gcloud run deploy "${SERVICE}" \
  ...
  --set-env-vars "MART_BUCKET=credit-pipeline-demo-marts,MART_OBJECT=mart_credit_features.parquet,MODEL_BUCKET=credit-pipeline-demo-models,MODEL_OBJECT=model-latest.pkl" \
